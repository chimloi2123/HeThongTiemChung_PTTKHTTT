...
CREATE TABLE CT_PHIEUTIEMGOI(
	MAPT char(7),
	MAGOI char(7),
	DONGIA int NOT NULL,
	NGTIEM DATE NOT NULL,

	PRIMARY KEY(MAPT,MAGOI)
)
...
CREATE TABLE CT_DONMUAGOI(
	MADDM char(7),
	MAGOI char(7),
	SOLUONG int,

	PRIMARY KEY(MADDM,MAGOI)
)
...
ALTER TABLE PHIEUTIEMVACXIN
ADD CONSTRAINT FK_HD_PT FOREIGN KEY (MAHD) REFERENCES HOADON(MAHD)
...
ALTER TABLE CT_PHIEUTIEMLE
ADD CONSTRAINT FK_PT_VX FOREIGN KEY (MAPT) REFERENCES PHIEUTIEMVACXIN(MAPT)
ALTER TABLE CT_PHIEUTIEMLE
ADD CONSTRAINT FK_VX_PT FOREIGN KEY (MAVX) REFERENCES VACXIN(MAVX)

ALTER TABLE CT_PHIEUTIEMGOI
ADD CONSTRAINT FK_PT_VX2 FOREIGN KEY (MAPT) REFERENCES PHIEUTIEMVACXIN(MAPT)
ALTER TABLE CT_PHIEUTIEMGOI
ADD CONSTRAINT FK_VX_PT2 FOREIGN KEY (MAGOI) REFERENCES GOIVACXIN(MAGOI)

ALTER TABLE CT_DONMUALE
ADD CONSTRAINT FK_DM_VX FOREIGN KEY (MADDM) REFERENCES DONMUA(MADDM)
ALTER TABLE CT_DONMUALE
ADD CONSTRAINT FK_VX_DM FOREIGN KEY (MAVX) REFERENCES VACXIN(MAVX)

ALTER TABLE CT_DONMUAGOI
ADD CONSTRAINT FK_DM_VX2 FOREIGN KEY (MADDM) REFERENCES DONMUA(MADDM)
ALTER TABLE CT_DONMUAGOI
ADD CONSTRAINT FK_VX_DM2 FOREIGN KEY (MAGOI) REFERENCES GOIVACXIN(MAGOI)
...
ADD CONSTRAINT FK_DDH_NCC FOREIGN KEY (MANCC) REFERENCES NHACUNGCAP(MANCC)
